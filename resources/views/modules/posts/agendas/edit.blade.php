            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Agendas</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    <div class="card">
                        <div class="card-body pt-10">
                            <form class="w-[60%]" id="editAgendaForm">
                                @csrf
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text"
                                                name="title" id="title" value="{{$agenda->title}}"/>
                                            <input class="form-control form-control-md form-control-solid" type="hidden"
                                                name="agenda_id" id="agenda_id" value="{{$agenda->id}}"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <textarea class="form-control form-control-md form-control-solid"
                                                type="text" name="description">{{$agenda->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text"
                                                name="location" id="location" value="{{$agenda->location}}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="date"
                                                name="agenda_date" id="agenda_date" value="{{$agenda->agenda_date}}" style="max-width: 250px;"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                <div class="flex justify-end">
                                    ...
                                    <a href="{{route('posts.agendas.index')}}" class="btn btn-danger">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
$('#editAgendaForm').on('submit', function(e) {
    ...
    const form = $('#editAgendaForm')[0];
    const formData = new FormData(form);
    const galeryId = $('#agenda_id').val();

    $.ajax({
        url: `/posts/agendas/update/${galeryId}`,
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
