                    ...
                    <div class="card">
                        <div class="card-body pt-10">
                            <form class="w-[60%]" id="newsForm">
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        <label class="form-label fw-bold fs-6 mb-2">Thumbnail</label></br>
                                        <img src="{{ asset('storage/' . $news->thumbnail_url) }}" width="100" class="mt-2" />
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <textarea class="form-control form-control-md form-control-solid"
                                                type="text" name="content" id="content">{{ $news->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
    ...
    $.ajax({
        ...
        success: function(response) {
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: 'News berhasil berhasil diperbarui!',
                timer: 2000,
