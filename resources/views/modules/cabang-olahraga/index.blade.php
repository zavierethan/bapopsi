        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Cabang Olahraga</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{route('cabang-olahraga.create')}}" class="btn btn-sm fw-bold btn-primary">New</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
...
<script>
    $("#kt_groups_table").DataTable({
        ...
        ajax: {
            url: `{{route('cabang-olahraga.get-lists')}}`, // Replace with your route
            type: 'GET',
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/cabang-olahraga/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Edit</a>
                        <div>
                    `;
                }
            }
