            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Group & Permission</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
...
<script>
    $("#kt_groups_table").DataTable({
        ...
        ajax: {
            url: `{{route('groups.get-lists')}}`, // Replace with your route
            type: 'GET',
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/groups/menu-access/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Menu Access & Permissions</a>
                        <div>
                    `;
                }
            }
